...
public class SMADLSemanticSequencer extends XbaseSemanticSequencer {

	@Inject
	private SMADLGrammarAccess grammarAccess;
	
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == SmadlPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case SmadlPackage.COMPUTATIONAL_UNIT:
				if(context == grammarAccess.getComputationalUnitRule()) {
					sequence_ComputationalUnit(context, (ComputationalUnit) semanticObject); 
					return; 
				}
				else break;
			...
			case SmadlPackage.GENERAL_CONSTRAINT:
				if(context == grammarAccess.getGeneralConstraintRule()) {
			...
			case SmadlPackage.SOCIAL_MACHINE:
				if(context == grammarAccess.getSocialMachineRule()) {
					sequence_SocialMachine(context, (SocialMachine) semanticObject); 
					return; 
				}
				else break;
			}
	...
	protected void sequence_GeneralConstraint(EObject context, GeneralConstraint semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, SmadlPackage.Literals.GENERAL_CONSTRAINT__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SmadlPackage.Literals.GENERAL_CONSTRAINT__TYPE));
		}
	 ...
	 *     )
	 */
	protected void sequence_SocialMachine(EObject context, SocialMachine semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
}
